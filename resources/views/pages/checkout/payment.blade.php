...
<section id="cart_items">
    <div class="container">
                        ...
                        <td class="cart_quantity">
                            <div class="cart_quantity_button">
                                <form action="{{URL::to('/update-cart-quantity')}}" method="POST">
                                    ...
                                    {{ csrf_field() }}
                                    <input class="cart_quantity_input" type="text" value="{{$v_content->qty}}" name="cart_quantity"  size="2">
        ...
        <h4 style="margin: 40px 0; font-sze:20px">Chọn hình thức thanh toán</h4>
        ...
        <div class="payment-options">
                ...
                <div>
                    <input type="submit" value="Đặt hàng" name="send_order_place" class="btn btn-primary btn-big">
                </div>
        </div>
