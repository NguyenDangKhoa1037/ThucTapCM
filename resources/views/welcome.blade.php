...
<head>
    ...
    <meta name="description" content="Chuyên bán phụ kiện game">
	<meta name="keywords" content="Tai nghe gaming, bàn phím gaming."/>
	<meta name="robots" content="INDEX,FOLLOW"/>
	{{-- <link  rel="canonical" href="{{$url_canonical}}" /> --}}
	<link  rel="icon" type="image/x-icon" href="" />
    <meta name="author" content="">
    <title>Phụ kiện chơi game chất lượng cao</title>
					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i>0354252504</a></li>
								<li><a href="#"><i class="fa fa-envelope"></i> suppervina@gmail.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
				...
				<div class="row">
					<div class="col-sm-4">
						<div class="companyinfo">
							<h2 style="margin-top: -50px"><span>KHOA</span> Gaming</h2>
						</div>
		...
		<div class="footer-top">
			<div class="container">
				<div class="row">
					<div class="col-sm-2">
						<div class="companyinfo">
							<h2><span>Khoa</span>-Gaming</h2>
							<p>Cung cấp phụ kiện cho game thủ.</p>
						</div>
					</div>
					<div class="col-sm-7">
						<div class="col-sm-3">
							<div class="video-gallery text-center">
								<a href="#">
									<div class="iframe-img">
										<img src="{{asset('public/upload/product/intropic.png')}}" alt="" />
									</div>
						...
						<div class="col-sm-3">
							<div class="video-gallery text-center">
								<a href="#">
									<div class="iframe-img">
										<img src="{{asset('public/upload/product/intropic1.jpg')}}" alt="" />
									</div>
									<div class="overlay-icon">
										<i class="fa fa-play-circle-o"></i>
									</div>
						...
						<div class="col-sm-3">
							<div class="video-gallery text-center">
								<a href="#">
									<div class="iframe-img">
										<img src="{{asset('public/upload/product/intropic2.jpg')}}" alt="" />
									</div>
									<div class="overlay-icon">
										<i class="fa fa-play-circle-o"></i>
									</div>
						...
						<div class="col-sm-3">
							<div class="video-gallery text-center">
								<a href="#">
									<div class="iframe-img">
										<img src="{{asset('public/upload/product/intropic3.jpg')}}" alt="" />
									</div>
									<div class="overlay-icon">
										<i class="fa fa-play-circle-o"></i>
									</div>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			$('.add-to-card').click(function(){
				...
				var cart_product_qtv = $('.cart_product_qtv_'+id).val();
				...
				$.ajax({
					...
					cart_product_qtv:cart_product_qtv,_token:_token},
